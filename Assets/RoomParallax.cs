...
public class RoomParallax : MonoBehaviour
{
    ...
    [SerializeField] float interiorWallParralxStrength;
    ...
    void Update()
    {
        ...
        rightWallInterior.position =  new Vector3(rightInteriorPos + Mathf.Lerp(0, rightScale, rightParrallax) * interiorWallParralxStrength, rightWallInterior.position.y, rightWallInterior.position.z);
        ...
        leftWallInterior.position =  new Vector3(leftInteriorPos + Mathf.Lerp(0, -leftScale, leftParrallax) * interiorWallParralxStrength, leftWallInterior.position.y, leftWallInterior.position.z);
